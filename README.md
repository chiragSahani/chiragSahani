...
|-----------|------------|--------------|---------|-----------|
| **[Nexus](https://github.com/chiragSahani/Nexus)** | `React` `Node.js` `Express` `MongoDB` | Full-Stack Web App | ![Status](https://img.shields.io/badge/Status-Production-blue) | [🌐 Live](https://chiragnexus.netlify.app/) |
| **[JobbyApp](https://github.com/chiragSahani/JobbyApp)** | `React` `REST APIs` `Authentication` `Routing` | Job Portal SaaS | ![Status](https://img.shields.io/badge/Status-Production-blue) | [🌐 Live](https://csahanijobby.ccbp.tech/login) |
| **[CareConnect](https://github.com/chiragSahani/CareConnect)** | `TypeScript` `React` `Chart.js` `Analytics` | Healthcare SaaS | ![Status](https://img.shields.io/badge/Status-Production-blue) | ![Healthcare](https://img.shields.io/badge/Healthcare-Platform-green) |
| **[InsydNotification](https://github.com/chiragSahani/InsydNotification)** | `TypeScript` `React` `Hooks` `Component Library` | NPM Package | ![Status](https://img.shields.io/badge/Status-Active-brightgreen) | ![NPM](https://img.shields.io/badge/NPM-Package-red) |
...
|---------|------------------|----------|-------------|
| **Backend Architecture** | `Microservices` `Docker` `API Gateway` | Enterprise Systems | ![Performance](https://img.shields.io/badge/Response-<100ms-green) |
| **ScrapWiki** | `Puppeteer` `Cheerio` `Node.js` `Data Mining` | Knowledge Extraction | ![Uptime](https://img.shields.io/badge/Uptime-99.9%25-brightgreen) |
...
![Deployment Status](https://img.shields.io/badge/Deployment-Success-brightgreen?style=for-the-badge&logo=vercel)
